...
const moreRows: FeatureRow[] = [
  ...
  { label: "Non-Comedogenic", rightText: "Non-Comedogenic", rightHas: false },
  ...
  { label: "Easy to Conceal Under Makeup", rightText: "Easy to Conceal Under Makeup", rightHas: false },
  { label: "Ideal for Daily Use", rightText: "Ideal for Daily Use", rightHas: false },
  ...
  { label: "Sulfate Free", rightText: "Sulfate Free", rightHas: false },
  { label: "Animal Cruelty Free", rightText: "Animal Cruelty Free", rightHas: false },
  { label: "Small Batch Production", rightText: "Small Batch Production", rightHas: false },
  ...
  return (
    <section className="w-full bg-[#FFFCF7] py-8 md:py-12">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="mb-[26px] md:mb-28 text-center">
