...
export const contentSectionsData: ContentSectionData[] = [
  ...
  },
  {
    ...
    bgColorClass: 'bg-[#1B1A1B]',
    imageSide: 'left',
    sideImageSrc: '/assets/spray-contentsections.jpg',
    sideImageAlt: 'JACKET Sunscreen',
...

  {
    ...
    sideImageSrc: '/assets/MINERALSTICKHOMEPAGEIMAGE.jpg',
    sideImageAlt: 'SPF 50+ Mineral Sunscreen Stick',
    productImageSrc: '/assets/jacketstickSPF50-transparent.png',
...

  {
    ...
    bgColorClass: 'bg-[#1B1A1B]',
    imageSide: 'left',
    sideImageSrc: '/assets/Lipbalm.jpg',
    sideImageAlt: 'JACKET Sunscreen',
    productImageSrc: '/assets/contentProduct4.png',
    productImageAlt: 'JACKET Sunscreen',
    titlePrimary: 'SPF 15',
    titleSecondary: 'LIP BALM',
    titlePrimaryColorClass: 'text-[#FBAC18]',
    titleSecondaryColorClass: 'text-[#FFFFFE]',
    bullets: [
   ...
   //test
   {
    ...
    bgColorClass: 'bg-[#8d8d8d]',
    imageSide: 'right',
    sideImageSrc: '/assets/TINTED MOISTURIZER HOMEPAGE IMAGE.jpg',
...

  {
    ...
    bgColorClass: 'bg-[#1B1A1B]',
    imageSide: 'left',
    sideImageSrc: '/assets/REFRESH HOMEPAGE IMAGE.jpg',
    sideImageAlt: 'JACKET Sunscreen',
