...
export const contentSectionsData: ContentSectionData[] = [
...

  {
    ...
    sideImageSrc: '/assets/MINERAL STICK HOMEPAGE IMAGE BW.jpg',
...

  {
    ...
    bgColorClass: 'bg-[#1B1A1B]',
    imageSide: 'left',
    sideImageSrc: '/assets/LIP BALM HOMEPAGE IMAGE BW.jpg',
    sideImageAlt: 'JACKET Sunscreen',
...

  {
    ...
    bgColorClass: 'bg-[#1B1A1B]',
    imageSide: 'left',
    sideImageSrc: '/assets/REFRESH HOMEPAGE IMAGE BW.jpg',
    sideImageAlt: 'JACKET Sunscreen',
