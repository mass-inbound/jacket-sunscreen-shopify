    ...
    <div className="bg-white">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-black">
          <div className="text-left">
            <h2 className="text-4xl lg:text-5xl font-bold mb-2 uppercase">
              YOU WERE MADE FOR
            </h2>
            <h3 className="text-4xl lg:text-5xl font-bold mb-2 uppercase">
              THIS.
            </h3>
            <h4 className="text-2xl lg:text-3xl font-bold uppercase">
              SO IS JACKET
            </h4>
          </div>
        </div>
      ...
      <img
                ...
                alt="JACKET Sunscreen"
                className="object-cover rounded-none max-w-4xl"
              />
      </div>
      {/* content 3 */}
       <div className="max-w-7xl mx-auto px-4 py-16 lg:py-24">
           ...
           <div className="lg:max-w-2xl">
             <div className="space-y-6">
               ...
               <h2 className="text-3xl lg:text-4xl font-bold text-black leading-tight">
                 FOR THE DOCTOR BEHIND<br />
                 JACKET, SUNSCREEN IS<br />
                 PERSONAL
               </h2>
