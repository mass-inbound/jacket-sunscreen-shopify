              ...
              <div key={item.id} className="border-b-4 border-[#FBAC18]">
                ...
                {openItems.includes(item.id) && (
                  <div className="pb-8">
                    ...
                    {/* Social Media Icons - Only show for first item */}
                    {item.id === 1 && (
                      <div className="flex items-center gap-4 mt-6">
                        {/* Facebook */}
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-6 h-6 flex items-center justify-center text-black hover:text-[#FBAC18] transition-colors">
                        ...
                        {/* Twitter/X */}
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-6 h-6 flex items-center justify-center text-black hover:text-[#FBAC18] transition-colors">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Link/Chain */}
                        <button className="w-6 h-6 flex items-center justify-center text-black hover:text-[#FBAC18] transition-colors">
